...
function serc_get_integrations_config()
{
    return [
        'cpf' => [
            ...
            ['id' => 'ic_telefone', 'name' => 'Busca por Telefone', 'description' => 'Localizar dados por telefone', 'shortcode' => 'serc_ic_telefone_form', 'value' => '6,90', 'type' => 'Requisição', 'icon' => 'ph-phone', 'fields' => [['name' => 'phone', 'label' => 'Telefone (com DDD)', 'placeholder' => '11999999999', 'type' => 'text', 'required' => true]]],
        ],
        'cnpj' => [
        ...
        'credito' => [
            ...
            ['id' => 'r_spc_srs', 'name' => 'SPC + Serasa', 'description' => 'Consulta combinada SPC e Serasa', 'shortcode' => 'serc_r_spc_srs_form', 'value' => '16,00', 'type' => 'Requisição', 'icon' => 'ph-list-star', 'fields' => [['name' => 'cpf', 'label' => 'CPF', 'placeholder' => '000.000.000-00', 'type' => 'text', 'required' => true, 'class' => 'cpf']]],
