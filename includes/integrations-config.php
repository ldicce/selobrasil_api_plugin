...
function serc_get_integrations_config()
{
    return [
        ...
        'veicular' => [
            ...
            ['id' => 'ic_bin_estadual', 'name' => 'BIN Estadual', 'description' => 'Base de Índice Nacional Estadual', 'shortcode' => 'serc_ic_bin_estadual_form', 'value' => '12,00', 'type' => 'Requisição', 'icon' => 'ph-map-pin', 'fields' => [['name' => 'placa', 'label' => 'Placa', 'placeholder' => 'ABC1D23', 'type' => 'text', 'required' => true], ['name' => 'state', 'label' => 'UF', 'placeholder' => 'SP', 'type' => 'text', 'required' => true]]],
